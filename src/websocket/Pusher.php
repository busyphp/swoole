...
class Pusher
{
     ...
     */
    public function __construct(Server $server, string $payload, int $sender = 0, array $descriptors = [], bool $broadcast = false, bool $assigned = false)
    {
        $this->sender      = $sender;
    ...
    {
        $this->descriptors = array_values(array_unique(array_merge($this->descriptors, $descriptors)));
